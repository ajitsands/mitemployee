	...
	ns.Upload.prototype.doUpload = function (upload_path,filename) {
		...
		$.ajax({
			...
			success: function (data) {
				...
				retval='success';
			//	console.log(retval);
				  $("#emp_img_preview").html("<img style='width:64px;height:64px;border-radius: 50%;'src=../httpdocs/images/employee_image/"+$.trim(filename)+">");
				 // $("#emp_image_div").html("<img style='width:100px;height:100px;'src=../httpdocs/images/employee_image/"+$.trim(filename)+">");
