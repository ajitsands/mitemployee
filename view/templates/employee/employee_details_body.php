                                ...
                                <div class="tab-pane fade active show" id="account" aria-labelledby="account-tab" role="tabpanel">
                                      ...
                                      <div class="col-md-12 col-12">
                                       <div class="card">
                                            ...
                                            <h4 class="card-title">Employee Details Form</h4><br>
											
                                        </div>
                                                    <div class="card-body">
													 <h6 style="background-color:gainsboro;padding-top:10px;">Personal Information</h6>
                                                        <?PHP  include('templates/employee/employee_details_add.php');?>
                                                    </div>
                                        </div>
                                     </div>
