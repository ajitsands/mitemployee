...
<body class="horizontal-layout horizontal-menu navbar-static 2-columns   footer-static  " data-open="hover" data-menu="horizontal-menu" data-col="2-columns">
   ...
   <!-- END: Main Menu-->
    ...
    <!-- BEGIN: Content-->
	 ...
	 <?PHP include('templates/employee/employee_body.php');?>
	<!-- END: Content-->
   ...
   <?PHP include('templates/footer.php');?>
    <!-- END: Footer-->
    <?PHP include('templates/employee/attachment_upload_modal.php');?>
    <?PHP include('templates/employee/profile_upload_modal.php');?>
    <?PHP include('templates/employee/user_type_modal.php');?>
    <?PHP include('templates/employee/department_modal.php');?>
    <?PHP include('templates/employee/dependent_modal.php');?>
